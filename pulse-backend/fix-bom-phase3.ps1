# Pulse Backend - Phase 3 BOM FIX script
# Rewrites the same files WITHOUT a UTF-8 BOM (BOM breaks PHP's <?php tag).
# Run from inside your pulse-backend folder:
#   powershell -ExecutionPolicy Bypass -File fix-bom-phase3.ps1

Write-Host "Rewriting Phase 3 files without BOM..." -ForegroundColor Cyan
...
'@
[System.IO.File]::WriteAllText("database\migrations\2024_01_03_000001_create_notes_table.php", $c0, $enc)
Write-Host "  Fixed: database\migrations\2024_01_03_000001_create_notes_table.php"
...
'@
[System.IO.File]::WriteAllText("app\Models\Note.php", $c1, $enc)
Write-Host "  Fixed: app\Models\Note.php"
...
'@
[System.IO.File]::WriteAllText("app\Http\Requests\StoreNoteRequest.php", $c2, $enc)
Write-Host "  Fixed: app\Http\Requests\StoreNoteRequest.php"
...
'@
[System.IO.File]::WriteAllText("app\Http\Requests\UpdateNoteRequest.php", $c3, $enc)
Write-Host "  Fixed: app\Http\Requests\UpdateNoteRequest.php"
...
'@
[System.IO.File]::WriteAllText("app\Http\Requests\AiNoteActionRequest.php", $c4, $enc)
Write-Host "  Fixed: app\Http\Requests\AiNoteActionRequest.php"
...
'@
[System.IO.File]::WriteAllText("app\Http\Resources\NoteResource.php", $c5, $enc)
Write-Host "  Fixed: app\Http\Resources\NoteResource.php"
...
'@
[System.IO.File]::WriteAllText("app\Http\Controllers\Api\V1\NoteController.php", $c6, $enc)
Write-Host "  Fixed: app\Http\Controllers\Api\V1\NoteController.php"
...
'@
[System.IO.File]::WriteAllText("app\Http\Controllers\Api\V1\AiController.php", $c7, $enc)
Write-Host "  Fixed: app\Http\Controllers\Api\V1\AiController.php"
...
'@
[System.IO.File]::WriteAllText("app\Services\AiService.php", $c8, $enc)
Write-Host "  Fixed: app\Services\AiService.php"
...
'@
[System.IO.File]::WriteAllText("routes\api.php", $c9, $enc)
Write-Host "  Fixed: routes\api.php"

Write-Host "All files rewritten without BOM." -ForegroundColor Green
Write-Host "Now run:" -ForegroundColor Yellow
Write-Host "  php artisan config:clear"
Write-Host "  (then restart php artisan serve)"
